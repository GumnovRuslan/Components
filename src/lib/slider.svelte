<script>
	...
	export let slides = [
		'https://99px.ru/sstorage/53/2023/01/tmb_348279_239176.jpg',
		'https://images.pexels.com/photos/640781/pexels-photo-640781.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500'
	];
